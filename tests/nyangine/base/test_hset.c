...
s32 main(void) {
  NYA_Arena arena = nya_arena_new(.name = "test_hset");

  // ─────────────────────────────────────────────────────────────────────────────
  // TEST: basic hashset creation
  // ─────────────────────────────────────────────────────────────────────────────
  u32HSet set = nya_hset_new(&arena, u32);
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  u32HSet set_cap = nya_hset_new_with_capacity(&arena, u32, 128);
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  u32HSet insert_set = nya_hset_new(&arena, u32);
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  u32HSet contains_set = nya_hset_new(&arena, u32);
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  u32HSet remove_set = nya_hset_new(&arena, u32);
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  u32HSet remove_first_last = nya_hset_new(&arena, u32);
  ...
  // TEST: nya_hset_clear
  // ─────────────────────────────────────────────────────────────────────────────
  u32HSet clear_set = nya_hset_new(&arena, u32);
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  u32HSet resize_set = nya_hset_new_with_capacity(&arena, u32, 8);
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  u32HSet stress_set = nya_hset_new(&arena, u32);
  ...
  // TEST: nya_hset_copy
  // ─────────────────────────────────────────────────────────────────────────────
  u32HSet orig_set = nya_hset_new(&arena, u32);
  ...
  // TEST: nya_hset_move
  // ─────────────────────────────────────────────────────────────────────────────
  NYA_Arena arena2 = nya_arena_new(.name = "test_hset_move");
  u32HSet move_set = nya_hset_new(&arena, u32);
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  u32HSet iter_set = nya_hset_new(&arena, u32);
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  s32HSet signed_set = nya_hset_new(&arena, s32);
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  u32HSet remove_nonexist = nya_hset_new(&arena, u32);
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  u32HSet empty_set = nya_hset_new(&arena, u32);
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  u32HSet dup_set = nya_hset_new(&arena, u32);
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  u32HSet destroy_set = nya_hset_new(&arena, u32);
  ...
  // TEST: nya_hset_union
  // ─────────────────────────────────────────────────────────────────────────────
  u32HSet union_a = nya_hset_new(&arena, u32);
  u32HSet union_b = nya_hset_new(&arena, u32);
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  u32HSet inter_a = nya_hset_new(&arena, u32);
  u32HSet inter_b = nya_hset_new(&arena, u32);
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  u32HSet diff_a = nya_hset_new(&arena, u32);
  u32HSet diff_b = nya_hset_new(&arena, u32);
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  u32HSet sym_a = nya_hset_new(&arena, u32);
  u32HSet sym_b = nya_hset_new(&arena, u32);
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  u32HSet empty_a = nya_hset_new(&arena, u32);
  u32HSet empty_b = nya_hset_new(&arena, u32);
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  u32HSet ident_a = nya_hset_new(&arena, u32);
  u32HSet ident_b = nya_hset_new(&arena, u32);
