...
NYA_API extern f16_2x2 nya_new_matrix(f16x2 row1, f16x2 row2) __attr_overloaded;
NYA_API extern f16_3x3 nya_new_matrix(f16x3 row1, f16x3 row2, f16x3 row3) __attr_overloaded;
NYA_API extern f16_4x4 nya_new_matrix(f16x4 row1, f16x4 row2, f16x4 row3, f16x4 row4) __attr_overloaded;
NYA_API extern f32_2x2 nya_new_matrix(f32x2 row1, f32x2 row2) __attr_overloaded;
NYA_API extern f32_3x3 nya_new_matrix(f32x3 row1, f32x3 row2, f32x3 row3) __attr_overloaded;
NYA_API extern f32_4x4 nya_new_matrix(f32x4 row1, f32x4 row2, f32x4 row3, f32x4 row4) __attr_overloaded;
NYA_API extern f64_2x2 nya_new_matrix(f64x2 row1, f64x2 row2) __attr_overloaded;
NYA_API extern f64_3x3 nya_new_matrix(f64x3 row1, f64x3 row2, f64x3 row3) __attr_overloaded;
NYA_API extern f64_4x4 nya_new_matrix(f64x4 row1, f64x4 row2, f64x4 row3, f64x4 row4) __attr_overloaded;

NYA_API extern f16x2 matrix_times_vector(f16_2x2 mat, f16x2 vec) __attr_overloaded;
NYA_API extern f16x3 matrix_times_vector(f16_3x3 mat, f16x3 vec) __attr_overloaded;
NYA_API extern f16x4 matrix_times_vector(f16_4x4 mat, f16x4 vec) __attr_overloaded;
NYA_API extern f32x2 matrix_times_vector(f32_2x2 mat, f32x2 vec) __attr_overloaded;
NYA_API extern f32x3 matrix_times_vector(f32_3x3 mat, f32x3 vec) __attr_overloaded;
NYA_API extern f32x4 matrix_times_vector(f32_4x4 mat, f32x4 vec) __attr_overloaded;
NYA_API extern f64x2 matrix_times_vector(f64_2x2 mat, f64x2 vec) __attr_overloaded;
NYA_API extern f64x3 matrix_times_vector(f64_3x3 mat, f64x3 vec) __attr_overloaded;
NYA_API extern f64x4 matrix_times_vector(f64_4x4 mat, f64x4 vec) __attr_overloaded;
