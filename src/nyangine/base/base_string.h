...
// clang-format off
NYA_API NYA_EXTERN b8              nya_string_contains(const NYA_String* str, const char* substr) __attr_overloaded;
NYA_API NYA_EXTERN b8              nya_string_contains(const NYA_String* str, const NYA_String* substr) __attr_overloaded;
NYA_API NYA_EXTERN b8              nya_string_ends_with(const NYA_String* str, const char* suffix);
NYA_API NYA_EXTERN b8              nya_string_equals(const char* str1, const char* str2) __attr_overloaded;
NYA_API NYA_EXTERN b8              nya_string_equals(const NYA_String* str1, const char* str2) __attr_overloaded;
...
NYA_API NYA_EXTERN b8              nya_string_starts_with(const NYA_String* str, const char* prefix);
...
NYA_API NYA_EXTERN NYA_String      nya_string_from(NYA_Arena* arena, const char* cstr) __attr_overloaded;
NYA_API NYA_EXTERN NYA_String      nya_string_join(NYA_Arena* arena, const NYA_StringArray* arr, const char* separator) __attr_overloaded;
...
NYA_API NYA_EXTERN NYA_String      nya_string_sprintf(NYA_Arena* arena, const char* fmt, ...) __attr_fmt_printf(2, 3);
...
NYA_API NYA_EXTERN NYA_StringArray nya_string_split(NYA_Arena* arena, const NYA_String* str, const char* separator) __attr_overloaded;
...
NYA_API NYA_EXTERN u64             nya_string_count(const NYA_String* str, const char* substr) __attr_overloaded;
...
NYA_API NYA_EXTERN void            nya_string_extend(NYA_String* str, const char* extension) __attr_overloaded;
...
NYA_API NYA_EXTERN void            nya_string_remove(NYA_String* str, const char* substr) __attr_overloaded;
NYA_API NYA_EXTERN void            nya_string_remove(NYA_String* str, const NYA_String* substr) __attr_overloaded;
NYA_API NYA_EXTERN void            nya_string_replace(NYA_String* str, const char* old, const char* new) __attr_overloaded;
NYA_API NYA_EXTERN void            nya_string_replace(NYA_String* str, const NYA_String* old, const NYA_String* new) __attr_overloaded;
...
NYA_API NYA_EXTERN s32             nya_string_sscanf(NYA_String* str, const char* fmt, ...) __attr_fmt_scanf(2, 3);
NYA_API NYA_EXTERN void            nya_string_strip_prefix(NYA_String* str, const char* prefix);
NYA_API NYA_EXTERN void            nya_string_strip_suffix(NYA_String* str, const char* suffix);
NYA_API NYA_EXTERN char*           nya_string_to_cstr(const NYA_String* str);
